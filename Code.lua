...
-- Function to apply recommended CVars for Steam Deck
local function ApplyRecommendedCVars()
    SetCVar("autoInteract", 1)
    SetCVar("cameraDistanceMaxZoomFactor", 2.6)
    SetCVar("ActionButtonUseKeyDown", 1)
    SetCVar("nameplateShowEnemies", 1)
    SetCVar("nameplateShowFriends", 1)
    print("|cff4beb2cRecommended CVars applied for Steam Deck.|r")
end
    ...
    E.Options.args[MyPluginName] = {
        ...
        args = {
            ...
            importElvUIProfile = {
                order = 6,
                type = "execute",
                name = "Import ElvUI Public Profile",
                desc = "Import the Steam Deck ElvUI public profile.",
                func = function()
                    ImportElvUIProfile()
                end,
            },
            importElvUIPrivateProfile = {
                order = 7,
                type = "execute",
                name = "Import ElvUI Private Profile",
                desc = "Import the Steam Deck ElvUI private profile.",
                func = function()
                    ImportElvUIPrivateProfile()
                end,
            },
            applyCVars = {
                order = 8,
                type = "execute",
                name = "Apply Recommended CVars",
                desc = "Apply recommended CVars for Steam Deck.",
                func = function()
                    ApplyRecommendedCVars()
                end,
            },
            toggleHeader = {
                order = 9,
    ...
    Pages = {
        ...
        [2] = function()
            return {
                ...
                Buttons = {
                    {
                        text = "Import ElvUI Public Profile",
                        func = ImportElvUIProfile,
                    },
                    {
                        text = "Import ElvUI Private Profile",
                        func = ImportElvUIPrivateProfile,
                    },
                    {
                        text = "Apply Recommended CVars",
                        func = ApplyRecommendedCVars,
                    },
                },
            }
        end,
        [3] = function()
            return {
                ...
                Buttons = {
                    {
                        text = "Import Plater Profile",
                        func = ImportPlaterProfile,
                    },
                },
            }
        end,
